...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .dashboard {
    ...
    min-height: 0;
    display: grid;
    grid-template-columns: minmax(330px, 0.95fr) minmax(330px, 1.05fr) minmax(280px, 0.8fr);
    gap: 14px;
  }
  .dashboard-col {
    min-height: 0;
  ...
  .recent-name { overflow: hidden; text-overflow: ellipsis; white-space: nowrap; font-size: 12px; font-weight: 720; }
  .recent-tool { margin-top: 3px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: var(--muted); font-size: 10px; }
